...
<div id="slider" class="row">
      ...
      <div class="row">
	      ...
	      <div class="col-sm-6 col-sm-offset-1" style="margin-top:25px">
	        ...
	        <p class="sp text-center">Speak Kazakh - это интересный и увлекательный способ изучить казахский язык. <br> Здесь ты будешь учить слова из лексического минимума, которые позволят тебе понимать основную казахскую речь.<br> Чем больше слов ты изучаешь, тем больше становится твой дракон!</p>
	      </div>
	      <div class="col-sm-4  ">
